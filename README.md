...
- **CI workflows**: [`.github/workflows/ci.yaml`](.github/workflows/ci.yaml) (PR tier, 20-min budget per SC-009), [`ci-workflow-dispatch.yaml`](.github/workflows/ci-workflow-dispatch.yaml) (full SLM, full load, IaC apply), [`nightly.yaml`](.github/workflows/nightly.yaml) (24h soak), [`record-corpus.yaml`](.github/workflows/record-corpus.yaml).
- **Infrastructure**: [`infra/terraform/`](infra/terraform/) — networking, compute (ECS-on-EC2 g5.2xlarge + Fargate per ADR-0005), data (RDS+Timescale, ElastiCache, MSK), storage (S3 weights / SBOM / artifacts), secrets (IAM least-privilege), observability (ADOT + AMP + AMG), EKS variant, CI runner.
